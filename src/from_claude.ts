...
import { AUTH_JSON_CANDIDATES, CONFIG_FILE } from "./storage.js"
import type { Account, AuthType } from "./types.js"
...
for (const [key, value] of Object.entries(env)) {
    ...
    tool: {
      ...
      account_status: tool({
        description:
          "Tampilkan status semua akun API yang terdaftar di Multi-Account Manager plugin, termasuk akun mana yang sedang aktif, rate-limited, disabled, atau invalid.",
        args: {},
