...
import type { Account, PluginConfig, RuntimeState } from "./types"
import { loadConfig, loadState, saveState, saveConfig, loadAuthJson, overwriteAuthJsonProvider, getActiveAuthJsonPath } from "./storage"
import { normalizeAccount, validateAccountCredentials } from "./provider-credentials"
...
export class AccountManager {
  ...
  switchToAccount(accountId: string): {
    ...
    reason?: "not_found" | "disabled" | "rate_limited"
  } {
    const account = this._findAccountById(accountId)
